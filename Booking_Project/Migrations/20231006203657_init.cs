        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StarRateing = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmentiesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Amenities_Hotels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Amenities_Hotels_Amenities_AmentiesId",
                        column: x => x.AmentiesId,
                        principalTable: "Amenities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Amenities_Hotels_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Image_Hotels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Image_Hotels_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableStatus = table.Column<string>(type: "varchar(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmenitiesRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AmenitiesRooms_Amenities_AmentiesId",
                        column: x => x.AmentiesId,
                        principalTable: "Amenities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AmenitiesRooms_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Image_Rooms", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NumOfGuest = table.Column<int>(type: "int", nullable: false),
                    CheckinDate = table.Column<DateTime>(type: "date", nullable: false),
                    CheckOutDate = table.Column<DateTime>(type: "date", nullable: false),
                    ReservationId = table.Column<int>(type: "int", nullable: false),
                    RoomId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Amenities_Hotels_AmentiesId",
                table: "Amenities_Hotels",
                column: "AmentiesId");

            migrationBuilder.CreateIndex(
                name: "IX_Amenities_Hotels_HotelId",
                table: "Amenities_Hotels",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_AmenitiesRooms_AmentiesId",
                table: "AmenitiesRooms",
                column: "AmentiesId");

            migrationBuilder.CreateIndex(
                name: "IX_AmenitiesRooms_RoomId",
                table: "AmenitiesRooms",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Image_Hotels_HotelId",
                table: "Image_Hotels",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_Image_Rooms_RoomId",
                table: "Image_Rooms",
                column: "RoomId");
